...
You might already have your Automation Priority Map from the [Diagnostic](/diagnostic). You know what to build.

The question is: are you going to build it?

Most operators don't. Not because they're not motivated — because:
...
✗ Operators who haven't identified what to build yet (start with the [Diagnostic](/diagnostic))
✗ Anyone looking for "done for you" — this is done-with-you
✗ Beginners without an active client base
...
*No commitment required. You'll receive an invitation when a cohort opens.*
...
**Do I need the Diagnostic first?**
It's strongly recommended. The Sprint is execution — it assumes you know what to build. If you don't have a Priority Map yet, [start there](/diagnostic).

**What tools will we be using?**
That depends on your stack and what you're building. Common tools include N8N, Make, Claude API, and various CRM integrations. You don't need prior experience — that's what the sessions are for.

**Can I do the Sprint without the Diagnostic?**
